...
import com.like.schoolShop.dao.LocalAuthDao;
...
public class LocalAuthDaoTest extends BaseTest {
	...
	private static final String username = "teaaa";
	...
	public void testDUpdateLocalAuth() throws Exception {
		...
		Date now = new Date();
		int effectedNum = localAuthDao.updateLocalAuth(1L, username, password, password + "1", now);
		assertEquals(1, effectedNum);
		// 查询出该条平台帐号的最新信息
		LocalAuth localAuth = localAuthDao.queryLocalByUserId(1L);
		// 输出新密码
